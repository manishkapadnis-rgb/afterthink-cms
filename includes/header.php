...
<body>
<header class="site-header py-3 border-bottom bg-white shadow-sm">
    <div class="container d-flex align-items-center justify-content-between">
        <a class="navbar-brand fw-bold text-dark logo" href="<?= baseUrl('index.php') ?>"><?= getSafe($siteSettings['site_name'] ?? 'Afterthink Studio') ?></a>
        <nav class="d-none d-md-flex gap-3 align-items-center main-nav">
